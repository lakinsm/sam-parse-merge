...
IlluminaParserJob::IlluminaParserJob(Args &args,
...
IlluminaParserJob::~IlluminaParserJob()
{
	_output_file.close();
}


void IlluminaParserJob::printInfo()
{
    std::cout << std::endl;
...
void IlluminaParserJob::_writeCurrentContents()
{
	for(int i = 0; i < contents.size(); ++i) {
		_output_file << contents[i] << std::endl;
	}
	contents.clear();
}


void IlluminaParserJob::_parsingSubroutine(std::ifstream &ifs, const std::string &first_line)
{
...
void IlluminaParserJob::_parseReadGroupData(std::vector< std::vector< std::string > > &read_group)
{
...
void IlluminaParserJob::_verifySingleEndData(std::vector< std::string > &single)
{
	std::stringstream ss;
	std::string entry;
	std::string out = "";
...
void IlluminaParserJob::_verifyUnpairedData(std::vector< std::string > &unpaired)
{
	std::stringstream ss;
	std::string entry;
	std::string out = "";
...
void IlluminaParserJob::_verifyReadPairData(std::vector< std::string > &forward, std::vector< std::string > &reverse)
{
...
void IlluminaParserJob::_transferPrimaryData(std::vector< std::string > &optimal) {
	std::stringstream ss;
...
std::vector< std::string > IlluminaParserJob::_findOptimalRead(std::vector< std::vector< std::string > > &directional_group)
{
...
std::vector< std::string > IlluminaParserJob::_parseSamLine(const std::string &sam_line)
{
    //      0          1        2      3    4    5      6        7
...
int IlluminaParserJob::_calcMatchLength(const std::string &cigar)
{
    int len = 0;
    std::string num = "";
    std::string op = "";
...
std::string IlluminaParserJob::_extractCigar(const std::string &this_line)
{
    std::string this_entry;
    std::stringstream ss;
    ss.str(this_line);
